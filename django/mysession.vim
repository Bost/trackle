...
nmap \df :Gdiff
nmap \st :Gstatus
nmap \cdf :color default:colorscheme default
nmap \- :sp
nmap \ss :mksession! ~/dev/mysite/mysession.vim
nmap <silent> \rs :source ~/dev/mysite/mysession.vim
nmap \r :source ~/.vimrc
nmap \ea :e ~/dev/cheatsheet/dotfiles/bash/aliases
nmap \ep :e ~/dev/cheatsheet/dotfiles/vim-plugins.sh
nmap \ec :e ~/dev/cheatsheet/cheatsheet.html
nmap \ev :e ~/.vimrc
nmap \sl :rightbelow vsp | Explore
nmap \sh :vsp | Explore
nmap \sj :rightbelow sp | Explore
nmap \sk :sp | Explore
nmap \MM \Mw\Mh
nmap \Mh :set lines=69
nmap \Mw :set columns=250
nmap \<S-Tab> :tabn
nmap \	 w
...
nmap <F12> :silent !google-chrome ~/dev/cheatsheet/cheatsheet.html
nnoremap <silent> <F11> :YRShow
nnoremap <silent> <F9> :NERDTreeToggle
map <F5> :w:!python "%"
map <F4> :execute "vimgrep /" . expand("<cword>") . "/j **" | cwindow
...
set shortmess=aoO
badd +1 ./manage.py
badd +1 ./mysite/urls.py
badd +1 ./mysite/settings.py
badd +1 ./mysite/wsgi.py
badd +1 ./polls/views.py
badd +1 ./polls/admin.py
badd +1 ./polls/models.py
badd +1 ./polls/tests.py
args ./manage.py ./mysite/urls.py ./mysite/settings.py ./mysite/wsgi.py ./polls/views.py ./polls/admin.py ./polls/models.py ./polls/tests.py
...
exe 'vert 1resize ' . ((&columns * 86 + 129) / 259)
exe 'vert 2resize ' . ((&columns * 86 + 129) / 259)
exe '3resize ' . ((&lines * 10 + 34) / 69)
exe 'vert 3resize ' . ((&columns * 85 + 129) / 259)
exe '4resize ' . ((&lines * 10 + 34) / 69)
exe 'vert 4resize ' . ((&columns * 85 + 129) / 259)
exe '5resize ' . ((&lines * 11 + 34) / 69)
exe 'vert 5resize ' . ((&columns * 85 + 129) / 259)
exe '6resize ' . ((&lines * 10 + 34) / 69)
exe 'vert 6resize ' . ((&columns * 85 + 129) / 259)
exe '7resize ' . ((&lines * 11 + 34) / 69)
exe 'vert 7resize ' . ((&columns * 85 + 129) / 259)
exe '8resize ' . ((&lines * 10 + 34) / 69)
exe 'vert 8resize ' . ((&columns * 85 + 129) / 259)
argglobal
edit ./mysite/settings.py
setlocal keymap=
setlocal noarabic
